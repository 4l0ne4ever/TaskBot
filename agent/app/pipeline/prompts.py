...
- For a named weekday (e.g. "Friday", "thứ Sáu", "Monday"): set "week_offset" to "this" when the phrase refers to the nearest upcoming occurrence, "next" when it means the following week (e.g. "next Friday", "thứ Sáu tới", "thứ Sáu sau"), or "after_next" when it means two weeks further (e.g. "the Friday after next", "thứ Sáu sau nữa"). Set "iso" to null — the pipeline computes the exact date from "week_offset" and the weekday name in "text". If the occurrence cannot be determined, set "week_offset" to "unknown", "is_ambiguous" to true, and lower confidence.
