...
Generated: 2026-05-10T11:34:03
Dataset: 240 samples, 17 categories
Errors (runtime): 0
...
|--------|-----------|--------|----|
| Title | 0.9847 | 0.9885 | 0.9866 |
| Assignee | 0.9958 | 0.9444 | 0.9695 |
| Conflict | 1.0000 | 0.8571 | 0.9231 |

| Metric | Score |
|--------|-------|
| Deadline Exact Match | 0.8658 |
| Deadline Near (+-1d) | 0.9004 |

| Abstention | Rate |
|------------|------|
| Correct abstain (GT empty) | 1.0 |
| False answer (GT empty) | 0.0 |
| False abstain (GT nonempty) | 0.015 |
...
ECE (vs bin midpoint): **0.1078** (n=258 paired w/ confidence)
...
|----------|---------|----------|-------------|----------|---------|-------------|
| conflict_assignee | 9 | 0.9474 | 0.8889 | 0.1111 | 0.1111 | 0.9412 |
| conflict_deadline | 12 | 0.8889 | 0.4000 | 0.8333 | 1.0000 | 0.9091 |
| doc_meeting_notes | 14 | 1.0000 | 1.0000 | 1.0000 | 1.0000 | 0.0000 |
| doc_simple | 20 | 1.0000 | 1.0000 | 1.0000 | 1.0000 | 0.0000 |
| edge_forwarded | 8 | 1.0000 | 1.0000 | 0.8750 | 1.0000 | 0.0000 |
| edge_mixed_lang | 9 | 1.0000 | 1.0000 | 0.4444 | 0.6667 | 0.0000 |
| edge_nickname | 7 | 1.0000 | 1.0000 | 1.0000 | 1.0000 | 0.0000 |
| edge_noisy_long | 8 | 1.0000 | 1.0000 | 1.0000 | 1.0000 | 0.0000 |
| edge_priority | 9 | 1.0000 | 1.0000 | 0.4444 | 0.6667 | 0.0000 |
...
| missing_assignee | 9 | 1.0000 | 0.0000 | 1.0000 | 1.0000 | 0.0000 |
| missing_deadline | 10 | 1.0000 | 1.0000 | 0.0000 | 0.0000 | 0.0000 |

## 3. Edge Case Performance

- Core categories weighted Title F1: **0.8366**
- Edge case categories weighted Title F1: **0.7727**
- Delta: **-0.0639**
...
|------------|-------|--------------|
| wrong_deadline | 23 | 9.6% |
| missed_assignee | 14 | 5.8% |
| deadline_off_by_one | 8 | 3.3% |
| hallucinated_task | 4 | 1.7% |
| missed_task | 3 | 1.2% |
| complete_miss | 3 | 1.2% |
| missed_conflict | 3 | 1.2% |
...
|----------|---|---|---|---|---|---|---|---|
| conflict_assignee | 0 | 0 | 1 | 1 | 1 | 0 | 1 | 8 |
| conflict_deadline | 0 | 2 | 3 | 9 | 2 | 0 | 0 | 0 |
| edge_forwarded | 0 | 1 | 0 | 0 | 0 | 0 | 0 | 0 |
| edge_mixed_lang | 0 | 2 | 0 | 0 | 0 | 0 | 0 | 3 |
| edge_priority | 0 | 2 | 0 | 0 | 0 | 0 | 0 | 3 |
...
### dc-137 (conflict_deadline, vi)

**Input:** Email thread:

[Email 1 — 2026-03-29]
Trần, proposal hợp tác nộp trước thứ Sáu nhé.

[Email 2 — 2026-03-31]
Cập nhật: proposal hợp tác cần nộp trước ngày mai.

**Expected tasks:** 1 | **Predicted:** 1
  - E: "Proposal hợp tác" | Trần | 2026-04-01 | pri=None
  - P: "nộp proposal hợp tác" | None | 2026-04-01 | pri=None
...
- Fully correct samples: **194/240** (80.8%)
- Samples with errors: **46/240** (19.2%)