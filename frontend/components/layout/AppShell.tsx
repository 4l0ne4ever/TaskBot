...
const nav = [
  ...
  // Phase 4 (no-deadline UX): Google-Tasks-like Kanban for tasks with no
  // deadline. Lives next to /calendar because the two are siblings — one
  // for date-anchored work, the other for date-less work.
  { href: "/tracking", label: "Tracking", icon: "M5 13l4 4L19 7" },
  ...
  { href: "/team", label: "Team", icon: "M17 20h5v-2a4 4 0 00-3-3.87M9 20H4v-2a4 4 0 013-3.87m6-1.13a4 4 0 10-4 0m8 0a4 4 0 00-3-7.75M5 8a4 4 0 014-4" },
  { href: "/admin", label: "Admin", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" },
];
